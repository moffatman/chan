...
class _GalleryPageState extends State<GalleryPage> with TickerProviderStateMixin {
	...
	double get _minScrollSheetSize {
		...
		if (currentController.videoPlayerController != null) {
			return 44 / MediaQuery.of(context, MediaQueryAspect.height).size.height;
		}
		return 0.0;
	}
													...
													child: Align(
														...
														child: Container(
															margin: showChrome ? EdgeInsets.only(
																bottom: (settings.showThumbnailsInGallery ? MediaQuery.of(context, MediaQueryAspect.height).size.height * 0.2 : 44) + 16 - (currentController.videoPlayerController == null ? 44 : 0),
																left: 16
