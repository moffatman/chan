	...
	Widget build(BuildContext context) {
		return TabWidgetBuilder(
			...
			builder: (context, data) {
				final currentImageboard = tab.imageboard;
				final currentThreadState = tab.persistence?.getThreadStateIfExists(tab.thread);
				final currentThread = currentThreadState?.thread;
				return ListTile(
					selected: selected,
					leading: SizedBox(
						width: 30,
