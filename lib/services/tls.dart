...
const kAndroidHello3 = TlsClientHello(
	versions: [0x0304],
...
const kDarwinHello3 = TlsClientHello(
	versions: [0x0304],
	ciphers: [0x1302,0x1303,0x1301],
...
void prepareTlsSettings({
	...
	required TlsSettings settings,
		...
		unsafeVoid(desired, () {
			...
			if (desiredExtensions.contains(_kTlsExtEncryptedClientHello)) {
				settings.useEchGrease = true;
				desiredExtensions.remove(_kTlsExtEncryptedClientHello);
			}
