...
class RefreshableListState<T extends Object> extends State<RefreshableList<T>> with SingleTickerProviderStateMixin {
	...
	Widget build(BuildContext context) {
		...
		controller.topOffset = padding.top;
		controller.bottomOffset = padding.bottom;
		final RegExp? queryPattern;
									...
									slivers: [
										SliverPadding(
											...
											sliver: SliverMainAxisGroup(slivers: [
												if (!widget.disableUpdates) CupertinoSliverRefreshControl(
												...
												SliverList(
													delegate: SliverChildListDelegate([
														...
														if (widget.footer != null && widget.disableUpdates) widget.footer!
														...
														if (!widget.disableUpdates && !widget.disableBottomUpdates) RepaintBoundary(
