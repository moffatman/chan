...
class SiteSoyjak extends SiteLainchan2 {
	...
	@override
	int get hashCode => Object.hash(baseUrl, name, captchaQuestion, Object.hashAll(boardsWithCaptcha ?? []), faviconPath, defaultUsername, overrideUserAgent, Object.hashAll(archives));
}